...
<p class="has-text-align-center has-primary-color has-text-color"><?php echo esc_html__( 'From Our Blog', 'tradeelite' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","fontSize":"main-title"} -->
<h2 class="wp-block-heading has-text-align-center has-main-title-font-size"><?php echo esc_html__( 'Recent News', 'tradeelite' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'Explore More', 'tradeelite' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->